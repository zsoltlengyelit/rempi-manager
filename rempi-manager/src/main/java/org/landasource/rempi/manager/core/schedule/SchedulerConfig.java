...
public class SchedulerConfig {
	...
	@Bean
	public SchedulerFactoryBean schedulerFactoryBean(final DataSource dataSource, final JobFactory jobFactory, @Qualifier("sampleJobTrigger") final Trigger sampleJobTrigger)
			throws IOException {
	...
	public SimpleTriggerFactoryBean sampleJobTrigger(@Qualifier("sampleJobDetail") final JobDetail jobDetail, @Value("${samplejob.frequency}") final long frequency) {
